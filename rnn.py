...
class RNN:
	...
	def define_layers(self):
		...
		word_decoder_layer = WordDecoderLayer(self.cell, random_generator, str(i+3), (sent_decoder_layer.out_size, self.out_size), sents_codes, self.mask_Y, self.is_train, self.drop_rate)
